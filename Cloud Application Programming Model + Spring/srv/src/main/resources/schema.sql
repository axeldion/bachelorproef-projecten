...
CREATE VIEW AdminService_Categories_texts AS SELECT
  Categories_texts_0.locale,
  Categories_texts_0.name,
  Categories_texts_0.descr,
  Categories_texts_0.ID
FROM sap_capire_products_Categories_texts AS Categories_texts_0;
...
CREATE VIEW AdminService_Products_texts AS SELECT
  Products_texts_0.locale,
  Products_texts_0.ID,
  Products_texts_0.title,
  Products_texts_0.descr
FROM sap_capire_products_Products_texts AS Products_texts_0;
