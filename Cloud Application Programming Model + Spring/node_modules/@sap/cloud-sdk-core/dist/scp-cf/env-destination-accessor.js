...
function getDestinationFromEnvByName(name) {
    if (getDestinationsEnvVariable()) {
        ...
        if (destinations[0] && proxy_util_1.proxyStrategy(destinations[0]) === proxy_util_1.ProxyStrategy.INTERNET_PROXY) {
            return proxy_util_1.addProxyConfigurationInternet(destinations[0]);
        }
