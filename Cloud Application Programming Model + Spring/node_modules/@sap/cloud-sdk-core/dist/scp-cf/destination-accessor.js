        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 3];
                case 2:
                    _a = options.iss ? { iss: options.iss } : undefined;
                    _d.label = 3;
                case 3:
                    decodedUserJwt = _a;
                    isolation = options.isolationStrategy ? options.isolationStrategy : cache_1.IsolationStrategy.Tenant;
                    selectionStrategy = options.selectionStrategy ? options.selectionStrategy : destination_selection_strategies_1.subscriberFirst;
                ...
                case 5:
                    ...
                    if (options.useCache) {
                        ...
                        if (providerDestinationCache &&
                            (selectionStrategy === destination_selection_strategies_1.alwaysProvider || (decodedUserJwt && jwt_1.isIdenticalTenant(decodedUserJwt, decodedProviderJwt)))) {
                            return [2 /*return*/, providerDestinationCache];
                        }
                    }
                    shouldExecuteSubscriberCalls = decodedUserJwt && !jwt_1.isIdenticalTenant(decodedUserJwt, decodedProviderJwt) && selectionStrategy !== destination_selection_strategies_1.alwaysProvider;
                ...
                case 8:
                    ...
                    if (emptyDestinationsByType(subscriberDestinations) && providerDestinationCache && selectionStrategy !== destination_selection_strategies_1.alwaysSubscriber) {
                        return [2 /*return*/, providerDestinationCache];
                    }
                ...
                case 11:
                    ...
                    if (!destination) return [3 /*break*/, 22];
                ...
                case 21:
                    ...
                    _d.label = 22;
                case 22: return [2 /*return*/, destination];
            }
        });
    });
}
...
function tryDestinationForServiceBinding(name) {
    try {
        return vcap_service_destination_1.destinationForServiceBinding(name);
    }
    catch (error) {
...
function tryDestinationFromEnv(name) {
    if (env_destination_accessor_1.getDestinationsEnvVariable()) {
        ...
        return env_destination_accessor_1.getDestinationFromEnvByName(name) || undefined;
    }
}
/**
...
var emptyDestinationByType = { instance: [], subaccount: [] };
function subscriberDestinationIsSelected(selectionStrategy) {
    return selectionStrategy === destination_selection_strategies_1.subscriberFirst || selectionStrategy === destination_selection_strategies_1.alwaysSubscriber;
}
...
function throwErrorWhenNull(obj, readableName) {
    if (!obj) {
