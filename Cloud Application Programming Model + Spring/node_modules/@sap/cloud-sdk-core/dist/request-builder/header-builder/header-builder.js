...
var buildHeadersAuthFirstCustomLast = function (request) { return function () {
    ...
    return cloud_sdk_util_1.asyncPipe.apply(void 0, __spreadArrays([function (headers) { return authorization_header_1.addAuthorizationHeader(request, headers); }], fns, [addCustomHeaders(request.config.customHeaders)]))({});
}; };
