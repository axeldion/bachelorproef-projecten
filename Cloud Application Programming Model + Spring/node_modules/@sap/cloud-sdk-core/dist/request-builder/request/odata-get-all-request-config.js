...
var ODataGetAllRequestConfig = /** @class */ (function (_super) {
    ...
    ODataGetAllRequestConfig.prototype.queryParameters = function () {
        var params = __assign(__assign(__assign({ format: 'json' }, get_selection_1.getQueryParametersForSelection(this.selects)), get_filters_1.getQueryParametersForFilter(this.filter, this.entityConstructor)), get_orderby_1.getQueryParametersForOrderBy(this.orderBy));
