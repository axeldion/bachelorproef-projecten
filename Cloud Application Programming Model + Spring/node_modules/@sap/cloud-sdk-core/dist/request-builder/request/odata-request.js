...
var ODataRequest = /** @class */ (function () {
    ...
    ODataRequest.prototype.execute = function () {
        return __awaiter(this, void 0, void 0, function () {
            var requestDataWithAxiosKeys;
            var _this = this;
            return __generator(this, function (_a) {
                if (!this._destination) {
                    throw Error('The destination cannot be undefined.');
                }
                requestDataWithAxiosKeys = __assign({ url: this.url(), method: this.config.method, data: this.config.payload }, http_agent_1.getAgentConfig(this._destination));
                return [2 /*return*/, this.headers()
                        .then(function (headers) { return (__assign(__assign({ headers: headers }, http_client_1.getAxiosConfigWithDefaults()), requestDataWithAxiosKeys)); })
