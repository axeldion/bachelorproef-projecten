...
function merge(generic, request) {
    return __assign(__assign(__assign({}, generic), request), { headers: __assign(__assign({}, (generic['headers'] || {})), request.headers) });
}
function executeWithAxios(request) {
    return axios_1.default.request(__assign({ proxy: false }, request));
}
/**
