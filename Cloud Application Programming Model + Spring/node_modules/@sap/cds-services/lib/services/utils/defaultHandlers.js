    ...
    [
      '@insertonly',
      {
        ...
        on: new Map([
          ...
          ...(isRoot ? PR_AC_DRAFT : [['draftPrepare', 'onDraftPrepare']])
        ]),
...
const _getDraftEnabledEntityHandlersCapabAnnot = isRoot => {
  return new Map([
    [
      'NotInsertable',
      {
        ...
        on: new Map([
          ...
          ...(isRoot ? [...PR_AC_DRAFT, ['EDIT', 'onDraftEdit']] : [['draftPrepare', 'onDraftPrepare']])
        ]),
    ...
    [
      ...
      {
        before: new Map(BEFORE_DRAFT),
        on: new Map([...ON_DRAFT, ...(isRoot ? PR_AC_DRAFT : [['draftPrepare', 'onDraftPrepare']])]),
...
const resolveCqnIfView = context => {
  const input = context.query.INSERT
    ? context.query.INSERT.entries
    : Object.assign({}, context.query.UPDATE.data || {}, context.query.UPDATE.with || {})
